    ...
    <>
      ...
      <main className={styles.mainContainer}>
        <div className={`${styles.main}`}>
          ...
          <PictureRow
            pictureRowContainer={styles.pictureRowContainer}
            pictureClassname={styles.pictureRow}
          />

          <h2>دسته بندی ای شاپ</h2>
          <MinimalCard
            data={data.digikalaCategoryData}
            classname={styles.categoryCardStyle}
            pictureDivider={styles.categoryPictureDivider}
            cardContainer={styles.mainPageCardContainer}
          />

          <h2>پیشنهاد ای شاپ</h2>
          <MinimalCard
            data={data.digikalaSuggestion}
            classname={styles.suggestionCardStyle}
            pictureDivider={styles.suggestPictureDivider}
            cardContainer={styles.mainPageCardContainer}
          />

          <NormalCarousel
            header="محبوب ترین برندها"
            carouselContainer={styles.normalCarouselContainer}
            PictureClassName={styles.brandPicture}
          />
