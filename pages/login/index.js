...
const index = () => {
   ...
   const validation = Yup.object({
        name:Yup.string().required('please enter name').min(3,'your name must be atleast 3 digit')
        .max(7,'your name must be maximun 7 digit'),
        mobile: Yup.number('your phone number must be from number').required('please enter you phone number')
